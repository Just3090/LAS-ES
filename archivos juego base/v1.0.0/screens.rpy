...
screen main_menu():
    ...
    add TrackCursor(Movie(play = "gui/mainmenubg.webm"), 20):
        xalign 0.25
        xzoom 1.1
        yzoom 1.1
    add TrackCursor("gui/mainmenuchar.png", 15):
        xalign 0.25
        xzoom 1.1
        yzoom 1.1
    add TrackCursor("gui/mainmenulogo.png", 20):
        xalign 0.25
        xzoom 1.1
        yzoom 1.1
...
screen download:
    imagebutton:
        #define position
        idle "DOWNLOADBUTTON.png"
        xalign 0.63
        yalign 0.47 
        action Jump("download")
        activate_sound("Soundbyte.mp3")
